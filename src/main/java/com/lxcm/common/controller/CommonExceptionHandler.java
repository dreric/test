 ...
 * @Description TODO 增强/通知 对后端控制器进行异常处理的增强
 * @Date 2020-03-16 16:22
 * @Created by lx
 */
@ControllerAdvice
public class CommonExceptionHandler {
     ...
     * @return
     */
    @ExceptionHandler(CizException.class)
    public ModelAndView handlerBizException(CizException e, HttpServletRequest request) {
